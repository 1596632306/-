  ...
  <div class="cart">
    <van-nav-bar title="购物车" fixed />
      <div class="cart-box" v-if="isLogin && cartList.length > 0">
        ...
        <!-- 购物车列表 -->
        <div class="cart-list">
          <div @click="toggleCheck(item.goods_id)" class="cart-item"  v-for="item in cartList" :key="item.goods_id">
            <van-checkbox  icon-size="18" v-model="item.isChecked" ></van-checkbox>
            <div class="show" @click="$route.push(`/prodetail/${item.goods_id}`)">
        ...
        <div class="footer-fixed">
          <div @click="toggleAllCheck" class="all-check">
            <van-checkbox  icon-size="18" v-model="isAllChecked"></van-checkbox>
            全选
          </div>
...
export default {
  ...
  computed: {
    ...mapState('cart', ['cartList', 'selCartList']),
